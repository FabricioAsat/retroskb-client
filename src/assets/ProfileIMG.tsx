    ...
    >
      ...
      <g data-name="Layer 2">
        <g data-name="\u2014\xCE\xD3\xC8 1">
          ...
          />
          <path
            d="M18.365 24.046c-3.07 1.339-.46 7.686 1.472 7.658a32 32 0 0 1-1.472-7.659zm25.775-.001c3.07 1.339.46 7.687-1.471 7.658a32 32 0 0 0 1.471-7.658"
            fill="#f9dca4"
            fillRule="evenodd"
          />
          <path
          ...
          />
          <path
            d="M25.767 61.373a31 31 0 0 1-3.779-.88l-.114-.093-3.535-6.39 4.541-3.26h-4.752l1.017-6.851 4.11-2.599c.178 7.37 1.759 15.656 2.512 20.073m10.878-.107c.588-.098 1.17-.234 1.747-.384a57 57 0 0 0 2.034-.579l.134-.043 3.511-6.315-4.541-3.242h4.752l-1.017-6.817-4.11-2.586c-.178 7.332-1.758 15.571-2.51 19.966"
            fill="#434955"
            fillRule="evenodd"
          />
        </g>
